        ...
        <div class="small-12 medium-9 columns">
            <div class="box">
                <h2>
                    ...
                    <span><a href="<?php echo site_url('campaigns/'.$campaign->id_token.'/opportunities/'.$opportunity->id_token.'/donations/'.$donation->id_token.'/edit') ?>" class="gi-button">Edit Donation</a></span>
                </h2>
