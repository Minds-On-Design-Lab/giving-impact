                                        ...
                                        <td style="color: #4c4c4d; font-family: arial, sans-serif; font-size: 14px; line-height: 18px;">
                                            <?php if( $campaign->campaign ) : ?>
                                                ...
                                                <?php if( $campaign->campaign->street_address_2 ) : ?>
                                                    <?php echo $campaign->campaign->street_address_2 ?><br />
                                                <?php endif ?>
                                            ...
                                            <p><strong style="text-weight: bold">Thank You for your <?php echo money_format('%n', $donation->amount/100) ?> <?php if( $donation->description ) : ?><?php echo $donation->description ?> <?php endif ?>donation to <?php echo $campaign->campaign ? $campaign->campaign->title : $campaign->title ?>.</strong></p>
                                            <?php if( $campaign->campaign ) : ?>
                                                <?php echo nl2br($campaign->campaign->receipt_body) ?>
                                            <?php else : ?>
                                                <?php echo nl2br($campaign->receipt_body) ?>
                                            <?php endif ?>
                                        </td>
                                    </tr>
                                </table>
