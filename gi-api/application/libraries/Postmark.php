 ...
 * Additional modifications to more closely integrate and allow for a single,
 * switchable email interface.
 *
 * #version		1.1
...
class Postmark extends CI_Email {
	...
	public function __construct($config = array())
	{
		...
		$this->api_key = $config['postmark_api_key'];
	}
...
//			get_instance()->log->entry('Postmark API: '.$return->Message, 2, true);
			return FALSE;
		}
